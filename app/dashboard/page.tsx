  ...
  return (
    <main className="min-h-dvh px-4 py-10 max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-2 gap-3 mb-8">
        ...
        <QuickAction href="/history"    icon={<ChartIcon />}      label="History"       sub="Review stats"            color="#C85A3A" />
      </div>
...
function QuickAction({ href, icon, label, sub, color }: {
  ...
  return (
    <Link href={href} className="card flex items-center gap-3 px-4 py-3.5 hover:shadow-md transition-all duration-200 group">
      <div
    ...
    <div className="card p-4 h-full cursor-pointer">
      <div className="flex items-start gap-3 mb-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="font-semibold text-[#1C1917] text-sm leading-tight truncate">{island.displayName}</div>
